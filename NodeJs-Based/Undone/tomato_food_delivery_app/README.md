...
2. Install Dependencies: 
   ...
   npm install
   ```
3. Set Up Environment Variables in the ***backend*** Directory: Add environment variables for MongoDB, Stripe keys, and JWT secrets in a `.env` file.
   The `.env` shoule containe the following:
   ```
   JWT_SECRET="random#secret"
   STRIPE_SECRET_KEY="dummy_key_here!"
