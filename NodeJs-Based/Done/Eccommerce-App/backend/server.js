    ...
    const sampleProducts = [
      {
        ...
        price: 99.99,
        image: process.env.HEADPHONES_IMAGE_URL || 'https://princewill-ecommerce-store.s3.us-east-1.amazonaws.com/products/headphones.jpg',
        stock: 15
      },
      {
        name: 'Smart Watch',
        ...
        price: 199.99,
        image: process.env.SMARTWATCH_IMAGE_URL || 'https://princewill-ecommerce-store.s3.us-east-1.amazonaws.com/products/laptop-stand.jpg',
        stock: 20
      },
      {
        name: 'Laptop Stand',
        ...
        price: 49.99,
        image: process.env.LAPTOPSTAND_IMAGE_URL || 'https://princewill-ecommerce-store.s3.us-east-1.amazonaws.com/products/smartwatch.jpg',
        stock: 25
      }
    ];
